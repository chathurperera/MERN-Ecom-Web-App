  ...
  return (
    <Routes>
      <Route path="/" element={<MainLayout />}>
        ...
        <Route path="shop" index element={<AllProducts />} />
        <Route path="all-products/:id" element={<SingleProduct />} />
        <Route path="checkout" element={<Checkout user={user.currentUser} />} />
        <Route path="order-success/:id" element={<OrderSuccess />} />
      </Route>
      <Route path="/my-account" element={<UserSharedLayout user={user.currentUser} />}>
